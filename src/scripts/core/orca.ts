...
export class Orca {
  ...
  public operate(operators: Operator[]) {
    this.release()
  ...
  public writeBlock = (x, y, block, overlap = false) => {
    if (!block) { return }
